          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                {
                  label: '1.3.6. Google TrueTime & Spanner: Working with Uncertainty',
                  translations: { tr: '1.3.6. Google TrueTime & Spanner: Belirsizlikle Çalışmak' },
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                {
                  label: '2.1.2. gRPC & Protocol Buffers: High-Performance RPC',
                  translations: { tr: '2.1.2. gRPC & Protocol Buffers: Yüksek Performanslı RPC' },
                  slug: 'communication/synchronous-protocols/grpc-protocol-buffers',
                },
                {
                  label: '2.1.3. gRPC Streaming: Unary, Server-Streaming, Bi-directional',
                  translations: { tr: '2.1.3. gRPC Streaming: Unary, Server-Streaming, Çift Yönlü' },
                  slug: 'communication/synchronous-protocols/grpc-streaming',
                },
                {
                  label: '2.1.4. GraphQL: Query Language and Federation Architecture',
                  translations: { tr: '2.1.4. GraphQL: Sorgu Dili ve Federasyon Mimarisi' },
                  slug: 'communication/synchronous-protocols/graphql',
                },
                {
                  label: '2.1.5. WebSocket and Server-Sent Events: Real-Time Communication',
                  translations: { tr: '2.1.5. WebSocket ve Server-Sent Events: Gerçek Zamanlı İletişim' },
                  slug: 'communication/synchronous-protocols/websocket-sse',
                },
                {
                  label: '2.1.6. API Versioning Strategies',
                  translations: { tr: '2.1.6. API Versiyonlama Stratejileri' },
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                {
                  label: '3.3.3. CAP Theorem: CP vs. AP Systems',
                  translations: { tr: '3.3.3. CAP Teoremi: CP ve AP Sistemler' },
                  slug: 'data-management/consistency-models/cap-theorem',
                },
                {
                  label: '3.3.4. PACELC Theorem: The Latency-Consistency Trade-off',
                  translations: { tr: '3.3.4. PACELC Teoremi: Gecikme-Tutarlılık Dengesi' },
                  slug: 'data-management/consistency-models/pacelc-theorem',
                },
                {
                  label: '3.3.5. Eventual Consistency: Last Write Wins (LWW) and Its Weaknesses',
                  translations: { tr: '3.3.5. Nihai Tutarlılık: Son Yazı Kazanır (LWW) ve Zayıflıkları' },
                  slug: 'data-management/consistency-models/eventual-consistency',
                },
                {
                  label: '3.3.6. CRDTs: Conflict-free Replicated Data Types',
                  translations: { tr: '3.3.6. CRDT\'ler: Çakışmasız Çoğaltılmış Veri Türleri' },
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                {
                  label: '4.3.4. Log-Structured Merge and Compaction',
                  translations: { tr: '4.3.4. Log Yapılı Birleştirme ve Compaction' },
                  slug: 'data-processing/hybrid-architectures/log-structured-merge',
                },
                {
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                {
                  label: '5.2.2. Paxos: Core Logic, Prepare and Accept Phases',
                  translations: { tr: '5.2.2. Paxos: Temel Mantık, Prepare ve Accept Aşamaları' },
                  slug: 'coordination/consensus-algorithms/paxos',
                },
                {
                  label: '5.2.3. Raft: Leader Election, Log Replication, Membership Changes',
                  translations: { tr: '5.2.3. Raft: Lider Seçimi, Log Replikasyonu, Üyelik Değişiklikleri' },
                  slug: 'coordination/consensus-algorithms/raft',
                },
                {
                  label: '5.2.4. Zab (ZooKeeper Atomic Broadcast): Epochs and Zxid',
                  translations: { tr: '5.2.4. Zab (ZooKeeper Atomic Broadcast): Dönemler ve Zxid' },
                  slug: 'coordination/consensus-algorithms/zab-zookeeper',
                },
                {
                  label: '5.2.5. etcd: Distributed K-V Storage on top of Raft',
                  translations: { tr: '5.2.5. etcd: Raft Üzerine Dağıtık K-V Depolama' },
                  slug: 'coordination/consensus-algorithms/etcd',
                },
                {
                  label: '5.2.6. Byzantine Fault Tolerance: PBFT, Proof of Work / Proof of Stake',
                  translations: { tr: '5.2.6. Bizans Hata Toleransı: PBFT, Proof of Work / Proof of Stake' },
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                {
                  label: '6.3.1. Client-Side Discovery: Eureka, Ribbon',
                  translations: { tr: '6.3.1. İstemci Taraflı Keşif: Eureka, Ribbon' },
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                {
                  label: '7.1.1. Backpressure: Pushing Load Back to the Source',
                  translations: { tr: '7.1.1. Geri Baskı: Yükü Kaynağa Geri Döndürmek' },
                  slug: 'resilience/flow-control/backpressure',
                },
                {
                  label: '7.1.2. Load Shedding: Which Requests to Drop and How',
                  translations: { tr: '7.1.2. Yük Atma: Hangi İstekler Düşürülür ve Nasıl' },
                  slug: 'resilience/flow-control/load-shedding',
                },
                {
                  label: '7.1.3. Priority Queues: Protecting Critical Requests',
                  translations: { tr: '7.1.3. Öncelik Kuyrukları: Kritik İstekleri Korumak' },
                  slug: 'resilience/flow-control/priority-queues',
                },
                {
                  label: '7.1.4. Rate Limiting: Token Bucket, Leaky Bucket, Fixed and Sliding Window',
                  translations: { tr: '7.1.4. Rate Limiting: Token Bucket, Leaky Bucket, Sabit ve Kayan Pencere' },
                  slug: 'resilience/flow-control/rate-limiting',
                },
                {
                  label: '7.1.5. Adaptive Rate Limiting: Dynamic Limits',
                  translations: { tr: '7.1.5. Uyarlanabilir Rate Limiting: Dinamik Sınırlar' },
            ...
            },
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  translations: { tr: '8.3.5. Emek: Operasyonel Yükü Ölçmek ve Azaltmak' },
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                {
                  label: '10.1.3. Istio: Control Plane Components (Pilot, Citadel, Galley)',
                  translations: { tr: '10.1.3. Istio: Kontrol Düzlemi Bileşenleri (Pilot, Citadel, Galley)' },
            ...
            },
            {
              ...
              items: [
                ...
                {
                  label: '10.3. Certificate Lifecycle: Cert-Manager, SPIFFE / SPIRE',
                  translations: { tr: '10.3. Sertifika Yaşam Döngüsü: Cert-Manager, SPIFFE / SPIRE' },
                  slug: 'service-mesh/network-policies-mtls/certificate-lifecycle',
                },
                {
                  label: '10.4. eBPF Networking: Kernel-Level CNI with Cilium',
                  translations: { tr: '10.4. eBPF Ağ: Cilium ile Kernel Düzeyinde CNI' },
                  slug: 'service-mesh/network-policies-mtls/ebpf-networking',
                },
                {
                  label: '10.5. Ingress vs. Gateway API: Next-Generation Traffic Management',
                  translations: { tr: '10.5. Ingress ve Gateway API: Yeni Nesil Trafik Yönetimi' },
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                {
                  label: '13.2.4. Using Vector Clocks for Conflict Resolution',
                  translations: { tr: '13.2.4. Çakışma Çözümü için Vektör Saat Kullanımı' },
