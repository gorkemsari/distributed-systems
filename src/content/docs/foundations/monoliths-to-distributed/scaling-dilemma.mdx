...
See [The 8 Fallacies of Distributed Computing](/distributed-systems/foundations/monoliths-to-distributed/eight-fallacies/) for the full taxonomy of assumptions that horizontal scaling invalidates.
